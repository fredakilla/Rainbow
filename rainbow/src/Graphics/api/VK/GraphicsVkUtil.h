...
/**
 * Maps rainbow::VertexFormat to VkFormat
 */
static const VkFormat lookupVkVertexFormat[] =
{
    VK_FORMAT_R32_SFLOAT,              // eFloat,
    VK_FORMAT_R32G32_SFLOAT,           // eFloat2,
    VK_FORMAT_R32G32B32_SFLOAT,        // eFloat3,
    VK_FORMAT_R32G32B32A32_SFLOAT,     // eFloat4,
    VK_FORMAT_R8G8B8A8_SINT,           // eByte4,
    VK_FORMAT_R8G8B8A8_SNORM,          // eByte4N,
    VK_FORMAT_R8G8B8A8_UINT,           // eUByte4,
    VK_FORMAT_R8G8B8A8_UNORM,          // eUByte4N,
    VK_FORMAT_R16G16_SINT,             // eShort2,
    VK_FORMAT_R16G16_SNORM,            // eShort2N,
    VK_FORMAT_R16G16B16A16_SINT,       // eShort4,
    VK_FORMAT_R16G16B16A16_SNORM,      // eShort4N,
    VK_FORMAT_UNDEFINED,               // eCount,
...
static PixelFormat toFormat(VkFormat pixelFormat)
{
    PixelFormat result = PixelFormat::eUndefined;
    switch (pixelFormat) 
    {
    case VK_FORMAT_R8_UNORM:
        result = PixelFormat::eR8Unorm;
        break;
    case VK_FORMAT_R16_UNORM:
        result = PixelFormat::eR16Unorm;
        break;
    case VK_FORMAT_R16_SFLOAT:
        result = PixelFormat::eR16Float;
        break;
    case VK_FORMAT_R32_UINT:
        result = PixelFormat::eR32Uint;
        break;
    case VK_FORMAT_R32_SFLOAT:
        result = PixelFormat::eR32Float;
        break;        
    case VK_FORMAT_R8G8_UNORM:
        result = PixelFormat::eR8G8Unorm;
        break;
    case VK_FORMAT_R16G16_UNORM:
        result = PixelFormat::eR16G16Unorm;
        break;
    case VK_FORMAT_R16G16_SFLOAT:
        result = PixelFormat::eR16G16Float;
        break;
    case VK_FORMAT_R32G32_UINT:
        result = PixelFormat::eR32G32Uint;
        break;
    case VK_FORMAT_R32G32_SFLOAT:
        result = PixelFormat::eR32G32Float;
        break;
    case VK_FORMAT_R32G32B32_UINT:
        result = PixelFormat::eR32G32B32Uint;
        break;
    case VK_FORMAT_R32G32B32_SFLOAT:
        result = PixelFormat::eR32G32B32Float;
        break;
    case VK_FORMAT_B8G8R8A8_UNORM:
        result = PixelFormat::eB8G8R8A8Unorm;
        break;
    case VK_FORMAT_R8G8B8A8_UNORM:
        result = PixelFormat::eR8G8B8A8Unorm;
        break;
    case VK_FORMAT_R16G16B16A16_UNORM:
        result = PixelFormat::eR16G16B16A16Unorm;
        break;
    case VK_FORMAT_R16G16B16A16_SFLOAT:
        result = PixelFormat::eR16G16B16A16Float;
        break;
    case VK_FORMAT_R32G32B32A32_UINT:
        result = PixelFormat::eR32G32B32A32Uint;
        break;
    case VK_FORMAT_R32G32B32A32_SFLOAT:
        result = PixelFormat::eR32G32B32A32Float;
        break;    
    case VK_FORMAT_D16_UNORM:
        result = PixelFormat::eD16Unorm;
        break;
    case VK_FORMAT_X8_D24_UNORM_PACK32:
        result = PixelFormat::eX8D24UnormPack32;
        break;
    case VK_FORMAT_D32_SFLOAT:
        result = PixelFormat::eD32Float;
        break;
    case VK_FORMAT_S8_UINT:
        result = PixelFormat::eS8Uint;
        break;
    case VK_FORMAT_D24_UNORM_S8_UINT:
        result = PixelFormat::eD24UnormS8Uint;
        break;
    case VK_FORMAT_D32_SFLOAT_S8_UINT:
        result = PixelFormat::eD32FloatS8Uint;
        break;
    }
    return result;
}
